...
if __name__ == '__main__':
    ...
    parser.add_argument('--sentinels', dest='sentinels', default='[":+1:", ":metal:"]', help='One or more strings to look for to count something as "reviewed"')
    ...
    main(args.sentinels, args.repo, args.token, args.since)
